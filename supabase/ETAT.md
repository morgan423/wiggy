...
| `0021_acceptations.sql`          | G7 : `legal_documents` et `acceptances`. ⚠️ BLOQUANTE : sans elle, le tunnel refuse toute réservation.                                        | En attente                  | Projet inexistant |
| `0022_matrice_notifications.sql` | B14 : une paire de bascules badge/push par événement.                                                                                         | En attente                  | Projet inexistant |
| `0023_push_web.sql`              | C9 ③ : `push_subscriptions`, un abonnement par appareil.                                                                                      | En attente                  | Projet inexistant |
| `0021_acceptations.sql`          | B2 : `client_notes`, le journal technique daté. L'existant n'est pas migré, à dessein.                                                        | Appliquée le 2026-09-03     | En attente        |
| `0022_matrice_notifications.sql` | B2 : `client_notes`, le journal technique daté. L'existant n'est pas migré, à dessein.                                                        | Appliquée le 2026-09-03     | En attente        |
| `0023_push_web.sql`              | B2 : `client_notes`, le journal technique daté. L'existant n'est pas migré, à dessein.                                                        | Appliquée le 2026-09-03     | En attente        |
