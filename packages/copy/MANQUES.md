...
| `agenda-tournee.$aEcrire.groupeAide`                       | « Ranger n’est pas obligatoire : sans groupe, ta liste reste simple. »                                                                                            |
...
| `reservation-cliente.$aEcrire.prestationsLabel`            | « Ses prestations »                                                                                                                                               |
| `reservation-cliente.$aEcrire.reserverAvec`                | « Réserver avec {pro} »                                                                                                                                           |
| `reservation-cliente.$aEcrire.des`                         | « dès »                                                                                                                                                           |
| `reservation-cliente.$aEcrire.groupeCompte`                | « {n} prestations »                                                                                                                                               |
| `reservation-cliente.$aEcrire.groupeDes`                   | « dès {prix} »                                                                                                                                                    |
| `reservation-cliente.$aEcrire.autresPrestations`           | « Ses {n} autres prestations »                                                                                                                                    |
| `reservation-cliente.$aEcrire.noteSur5`                    | « {note} sur 5 »                                                                                                                                                  |
| `reservation-cliente.$aEcrire.noteAvecAvis`                | « · {n} avis, à lire en bas de page »                                                                                                                             |
| `reservation-cliente.$aEcrire.noteSansMoyenne`             | « · à lire en bas de page »                                                                                                                                       |
| `reservation-cliente.$aEcrire.avisCompte`                  | « {n} avis »                                                                                                                                                      |
| `reservation-cliente.$aEcrire.autresPrestationsUne`        | « Son autre prestation »                                                                                                                                          |
| `reservation-cliente.$aEcrire.groupeCompteUne`             | « 1 prestation »                                                                                                                                                  |
| `agenda-tournee.$aEcrire.groupeAucun`                      | « Aucun groupe »                                                                                                                                                  |
| `agenda-tournee.$aEcrire.groupeCreer`                      | « Créer un groupe »                                                                                                                                               |
| `agenda-tournee.$aEcrire.groupeNouveauLabel`               | « Nom du nouveau groupe »                                                                                                                                         |
| `agenda-tournee.$aEcrire.prestationModifier`               | « Modifier »                                                                                                                                                      |
| `agenda-tournee.$aEcrire.prestationTitreEdition`           | « Modifier la prestation »                                                                                                                                        |
| `agenda-tournee.$aEcrire.prestationEnregistrer`            | « Enregistrer »                                                                                                                                                   |
| `agenda-tournee.$aEcrire.groupesTitre`                     | « Tes groupes »                                                                                                                                                   |
| `agenda-tournee.$aEcrire.groupeRenommer`                   | « Renommer »                                                                                                                                                      |
| `demandes-pro.$aEcrire.forfaitTitre`                       | « Proposer un forfait de déplacement »                                                                                                                            |
| `demandes-pro.$aEcrire.forfaitAide`                        | « Cette adresse est hors de ta zone. Le montant s’ajoute au prix, et ta cliente le confirme avant que le rendez-vous existe. »                                    |
| `demandes-pro.$aEcrire.forfaitLabel`                       | « Montant du forfait »                                                                                                                                            |
| `demandes-pro.$aEcrire.forfaitBase`                        | « Ton forfait de base »                                                                                                                                           |
| `demandes-pro.$aEcrire.forfaitEnvoyer`                     | « Proposer le forfait »                                                                                                                                           |
